...
const DailyStudentReportPage: React.FC<DailyStudentReportPageProps> = ({ students }) => {
    ...
    useEffect(() => {
        setSelectedTeacher('');
        setSelectedCircle('');
    }, [selectedDay, selectedCircleTime]);
    ...
    }, [students, selectedDay, selectedCircleTime]);
    ...
    }, [students, selectedDay, selectedCircleTime, selectedTeacher]);
            ...
            <div className="mb-8 bg-white p-6 rounded-xl shadow-lg border border-stone-200 print-hidden">
                <div className="grid grid-cols-1 md:grid-cols-6 gap-4 items-end">
                    <div className="md:col-span-1">
                        <label htmlFor="day-filter" className="block text-sm font-medium text-stone-700 mb-2">فلترة حسب اليوم</label>
                        <select
                            id="day-filter"
